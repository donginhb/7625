...
extern INT8U  video_flag, motion_flag;
...
//        		ap_music_update_icon_status();
			...
			case MSG_APQ_POWER_ON_AUTO_RECORD:
				...
				if(1/*power_on_flag || card_insert_autorecord*/) 
				{
					power_on_flag = 0;
		        	...
		        	DBG_PRINT("MODECTION_FLAG = %d, AUTO_Record_start!!!!", MODECTION_FLAG);
		        }
				#endif
				break;
